					...
					<div class="profile-usermenu">
						...
						<li ><a
								href="<c:url value="/myprofile/info?userId=${user._id }"/>">
									<i class="glyphicon glyphicon-info-sign"></i> Thông
									tin cá nhân
							</a></li>
							<li><a
							...
							<c:if test="${user.role.contains('User')}">
								<li class="active"><a
									...
									> <i
										class="glyphicon glyphicon-shopping-cart"></i> Quản lý đơn
										hàng
								</a></li>
							</c:if>
							<li><a
						...
						<tbody>
							<c:forEach items="${orderList }" var="order" varStatus="STT">
								<tr>
									...
									<td><a
										href="<c:url value='/admin2/order/detail?orderId=${order._id }'/>"
										class="btn btn-success">Chi tiết </a> <a
										href="<c:url value='/admin2/order/delete?orderId=${order._id }'/>"
