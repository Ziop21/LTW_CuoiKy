				...
				<div class="profile-content">
					...
					<a class="btn btn-primary" style="font-size:16px" href="<c:url value='/myprofile/regisvendor?userId=${user._id }'/>">Đăng ký vendor</a>
						<table class="table ">
							...
							<tbody>
								<c:forEach items="${vendorRegisList }" var="vendorRegis"
									varStatus="STT">
									<tr>
										...
										<td><span class="name">${vendor.isApproved==true ? 'Đã duyệt':'Chưa duyệt' }</span></td>
										<td><a
											href="<c:url value='/myprofile/delete-regisvendor?Id=${vendorRegis._id }&userId=${user._id }'/>"
