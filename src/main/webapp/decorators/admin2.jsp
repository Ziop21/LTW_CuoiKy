...
<!-- Header -->
<%@ include file="/commons/admin2/header.jsp"%>

<dec:body />

<!-- Footer -->
<jsp:include page="/commons/admin2/footer.jsp"></jsp:include>
<!-- Scripts -->
<script
...
<script>
				...
				var myChart = new Chart(ctx, {
					...
					data : {
						...
						datasets : [ {
							label : "So luong theo thang",
							data : [ 11, 22, 33, 44, 55, 55, 66, 66, 77, 77, 88, 11 ],
